...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/rafsstore/script/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/rafsstore/script/main/badvpn/antcrashvpn.sh -o /dev/null
